...
<head>
    ...
    <meta property="og:title" content="PINTARBOLA - Spin & Win" />
    ...
    <meta property="og:image" content="https://img.hiicord.com/gambar/GAPURABOLA.jpg" />
    <meta property="og:image:width" content="1200" />
    <meta property="og:image:height" content="630" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:site" content="@replit" />
    <meta name="twitter:title" content="PINTARBOLA - Spin & Win" />
    <meta name="twitter:description" content="Putar roda keberuntungan dan menangkan hadiah hingga 200 ribu! Gratis dan mudah." />
    <meta name="twitter:image" content="https://img.hiicord.com/gambar/GAPURABOLA.jpg" />
    <title>PINTARBOLA - Spin & Win Lucky Wheel</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        .wheel-outer {
            ...
            box-shadow:
				...
				inset 0 0 15px rgba(27, 94, 32, 0.4);
        ...
        .wheel-inner {
            ...
            background: conic-gradient(
                ...
                #ffcb54 0deg 60deg,
                #ffffff 60deg 120deg,
                #ffcb54 120deg 180deg,
                #ffffff 180deg 240deg,
                #ffcb54 240deg 300deg,
        ...
        button:hover:not(:disabled) {
            ...
            background: linear-gradient(to bottom, #FFED4E, #c62828);
        }
...
<body>
        ...
        <div class="main-content">
            ...
            <div>
                ...
                <div class="winners-section">
                    <div class="winners-header">🏆 50 Daftar Riwayat Spin Terakhir</div>
    ...
    <div class="floating-chat">
        ...
        <a href="https://pintarslaw.com/" target="_blank" rel="noopener noreferrer" class="chat-button" title="Chat CS 24/7">
            <svg fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <script>
        ...
        function claimPrize() {
            window.location.href = 'https://pintarslaw.com/';
        }
